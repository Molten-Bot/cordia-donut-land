...
function drawRoad(ctx, width, height, cameraX) {
...
function drawHole(ctx, hole) {
    const gradient = ctx.createRadialGradient(hole.x - hole.radius * 0.22, hole.y - hole.radius * 0.26, hole.radius * 0.18, hole.x, hole.y, hole.radius);
